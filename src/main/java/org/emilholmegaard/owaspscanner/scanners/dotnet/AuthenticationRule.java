...
public class AuthenticationRule extends AbstractDotNetSecurityRule {
    ...
    private static final String REMEDIATION = 
            "Use ASP.NET Core Identity with strong password policies. Implement secure password " +
    ...
    private static final Pattern PATTERN = 
            Pattern.compile("(?i)password|authenticate|login|signin|hash|identity|user manager|usermanager");
    ...
    protected boolean checkViolation(String line, int lineNumber, RuleContext context) {
        ...
        // Custom authentication implementations should be flagged unless they use secure practices
