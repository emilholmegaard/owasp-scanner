...
public class SessionManagementRule extends AbstractDotNetSecurityRule {
    ...
    private static final String REMEDIATION = 
            "Configure sessions with secure settings: HttpOnly, Secure flags, and appropriate " +
    ...
    private static final Pattern PATTERN = 
            Pattern.compile("(?i)Session|Cookie|HttpOnly|SameSite|CookieOptions|UseCookiePolicy");
